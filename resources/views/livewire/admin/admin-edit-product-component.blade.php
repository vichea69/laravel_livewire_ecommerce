                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-header">
                            ...
                            <div class="row-cols-md-6">
                                <a href="{{route('admin.products')}}" class="btn btn-primary float-end">All Product</a>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data"  wire:submit.prevent="updateProduct">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="file" class="form-control" name="image" placeholder="Image" wire:model="newimage">
                                    @if($newimage)
